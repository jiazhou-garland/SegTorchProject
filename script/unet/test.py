...
if __name__ == '__main__':
    # img_path="/media/jim/DISK/TEMP/Datasets/Others/suichang_round1_train_210120/000001.tif"
    ...
    # print(image.shape)
    # ----------------------------------------------------------------------------------------------
    model_ckpt="../checkpoint/unet/20210210_172221/models/state_dict_model_e_16.pt"
    model = UNet(
        dimensions=2,
        in_channels=4,
        out_channels=10,
